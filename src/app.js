...
import {createApiDocRouter, createBulkRouter, createLogsRouter, createPrioRouter, createPrioChunkRouter} from './routes/index.js';
...
export default async function ({
  ...
  async function initExpress() {
    ...
    app.use('/priochunk', ipWhiteListMiddleware, passport.authenticate('melinda', {session: false}), await createPrioChunkRouter({mongoUri, amqpUrl, recordType, allowedLibs})); // Must be here to avoid bodyparser
