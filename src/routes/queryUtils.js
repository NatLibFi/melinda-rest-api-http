...
export function checkQueryParams(req, res, next) {
  ...
  const failedParams = [
    ...
    {name: 'pRejectFile', value: queryParams.pRejectFile ? (/^[a-z|A-Z|0-9|/|\-|.]{0,100}$/u).test(queryParams.pRejectFile) : true},
    {name: 'pLogFile', value: queryParams.pLogFile ? (/^[a-z|A-Z|0-9|/|\-|.]{0,100}$/u).test(queryParams.pLogFile) : true},
